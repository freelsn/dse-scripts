...
def is_whole_word_in_string(word, string):
    return re.search(r'\b{}\b'.format(word), string)
...
def main():
    ...
    if is_whole_word_in_string('adpcm_encoder', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 20
    # aes, -c2000
    elif is_whole_word_in_string('aes', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # ann, -c4000
    elif is_whole_word_in_string('ann', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # average, -c1000
    elif is_whole_word_in_string('average', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.folding_opt = [0, 1]
    # dct, -c1000
    elif is_whole_word_in_string('dct', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # decimation, -c2000
    elif is_whole_word_in_string('decimation', ga_mo.source_file):
        ga_mo.array_bw = 1
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # fft_fixed, -c4000
    elif is_whole_word_in_string('fft_fixed', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # fir, -c2000
    elif is_whole_word_in_string('fir', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # huffman, -c1000
    elif is_whole_word_in_string('huffman', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # idct, -c10000
    elif is_whole_word_in_string('idct', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # interpolation, -c4000
    elif is_whole_word_in_string('interpolation', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # kasumi, -c50000
    elif is_whole_word_in_string('kasumi', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # md5c, -c50000
    elif is_whole_word_in_string('md5c', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 3
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # qsort, -c2000
    elif is_whole_word_in_string('qsort', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # quantization, -c1000
    elif is_whole_word_in_string('quantization', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # rle, -c1000
    elif is_whole_word_in_string('rle', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # snow3g, -c2000
    elif is_whole_word_in_string('snow3g', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
        ...
        ga_mo.pop_size = 64
    # sobel, -c2000
    elif is_whole_word_in_string('sobel', ga_mo.source_file):
        ga_mo.array_bw = 2
        ga_mo.loop_bw = 2
        ga_mo.func_bw = 1
        ga_mo.fu_ratio_bw = 3
