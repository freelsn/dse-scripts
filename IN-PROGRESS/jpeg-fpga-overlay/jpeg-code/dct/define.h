...
#define NUM_BLOCK 1 //number of input blocks per write from HPS
...
#define DCT_OUT_WIDTH 64   //DCT output bitwidth
#define QUAN_OUT_WIDTH 64  //quantization output bitwidth
