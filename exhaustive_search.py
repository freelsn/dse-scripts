...
def set_attributes(benchmark):
    ...
    elif 'interpolation' in benchmark:
        # -c4000
        arrays = (
            [0, 1, 2],
            [0, 1, 2],
